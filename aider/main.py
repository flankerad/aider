...
from aider.deprecated import handle_deprecated_model_args
from aider.format_settings import format_settings, scrub_sensitive_info
# from aider.history import ChatSummary # Replaced by RedisHistoryManager
from aider.io import InputOutput
from aider.llm import litellm  # noqa: F401; properly init litellm on launch
from aider.models import ModelSettings
from aider.onboarding import offer_openrouter_oauth, select_default_model
...
def main(argv=None, input=None, output=None, force_git_root=None, return_coder=False):
    ...
    def get_io(pretty):
        return InputOutput(
            ...
            args.yes_always,
            args.input_history_file,
            # args.chat_history_file, # Removed, history now in Redis
            input=input,
            output=output,
            user_input_color=args.user_input_color,
    ...
    try:
        ...
        # Set coder reference in commands after coder is created
    ...
    if args.test:
        if not args.test_cmd:
            ...
            return 1
        commands.cmd_test(args.test_cmd)
        if io.placeholder:
